...
$stmt = $conn->prepare("SELECT * FROM students WHERE center_id = ?");
$stmt->execute([$center_id]);
$students = $stmt->fetchAll(PDO::FETCH_ASSOC);

if (isset($_GET['delete'])) {
    $id = sanitize_input($_GET['delete']);
    $stmt = $conn->prepare("SELECT image, id_card FROM students WHERE id = ? AND center_id = ?");
    ...
    if ($files) {
        ...
        $conn->prepare("DELETE FROM students WHERE id = ? AND center_id = ?")->execute([$id, $center_id]);
...
<html>
<head>
    <title>Center Student List</title>
...
<body>
    ...
    <div class="container">
        <div class="card p-4">
            ...
            <table class="table table-striped table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="center_edit_student.php?id=<?php echo $student['id']; ?>" class="btn btn-sm btn-primary">Edit</a>
            ...
            <a href="center_add_student.php" class="btn btn-primary">Add New Student</a>
        </div>
    </div>
